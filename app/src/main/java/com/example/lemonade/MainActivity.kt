...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lemonImage = findViewById(R.id.image)
        setViewElements()
    ...
    private fun setViewElements() {
        ...
        val lemonImage: ImageView = findViewById(R.id.image)

        when (lemonadeState){
            "SELECT" -> {textAction.text = resources.getString(R.string.lemon_select)
                lemonImage.setImageResource(R.drawable.lemon_tree)
            }
            "SQUEEZE" -> {textAction.text = resources.getString(R.string.lemon_squeeze)
                lemonImage.setImageResource(R.drawable.lemon_squeeze)
            }
            "DRINK" -> {textAction.text = resources.getString(R.string.lemon_drink)
                lemonImage.setImageResource(R.drawable.lemon_drink)
            }
            "RESTART" -> {textAction.text = resources.getString(R.string.lemon_empty_glass)
